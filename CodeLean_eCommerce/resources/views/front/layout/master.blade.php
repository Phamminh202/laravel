                                ...
                                <div class="select-items">
                                    <table>
                                        ...
                                        @foreach(Cart::content() as $cart)
                                            <tr>
                                                <td class="si-pic"><img style="height: 170px" src="front/img/products/{{$cart->options->images[0]->path}}" alt=""></td>
                                                <td class="si-text">
    ...
    <div class="nav-item">
        <div class="container">
            ...
            <nav class="nav-menu mobile-menu">
                <ul>
                    <li class="{{ (request()->segment(1)=='') ? 'active' : '' }}"><a href="index.html">Home</a></li>
                    <li class="{{ (request()->segment(1)=='shop') ? 'active' : '' }}"><a href="shop.html">Shop</a></li>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="footer-left">
                    ...
                    <ul>
                        <li>Vu Thu - Thai Binh</li>
                        <li>Phone:0866133204</li>
                        <li>Email:pminh1410@gmail.com</li>
                    </ul>
